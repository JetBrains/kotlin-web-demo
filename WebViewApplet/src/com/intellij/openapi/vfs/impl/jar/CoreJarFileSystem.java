...
public class CoreJarFileSystem extends DeprecatedVirtualFileSystem {
    private static final Map<String, CoreJarHandler> myHandlers = new HashMap<String, CoreJarHandler>();
    ...
    /*public static void addRtJar() {
        myHandlers.put("rt.jar", new CoreJarHandler(new CoreJarFileSystem(), "rt.jar"));
    }*/
}
