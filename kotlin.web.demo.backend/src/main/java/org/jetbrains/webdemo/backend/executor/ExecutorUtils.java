...
public class ExecutorUtils {
    private static List<Path> jarFiles = Arrays.asList(
            ...
            Paths.get(BackendSettings.EXECUTORS_LIBS_DIR, "jackson-databind-2.8.5.jar"),
            Paths.get(BackendSettings.EXECUTORS_LIBS_DIR, "jackson-core-2.8.5.jar"),
            Paths.get(BackendSettings.EXECUTORS_LIBS_DIR, "jackson-annotations-2.8.5.jar")
    );
