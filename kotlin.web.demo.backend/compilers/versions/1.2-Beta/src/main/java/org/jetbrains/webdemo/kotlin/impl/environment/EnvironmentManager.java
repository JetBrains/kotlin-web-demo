...
public class EnvironmentManager {
    ...
    private static KotlinCoreEnvironment createEnvironment(List<Path> libraries) {
        ...
        configuration.put(JVMConfigurationKeys.DISABLE_PARAM_ASSERTIONS, arguments.getNoParamAssertions());
        configuration.put(JVMConfigurationKeys.DISABLE_CALL_ASSERTIONS, arguments.getNoCallAssertions());
        ...
        project.registerService(NullableNotNullManager.class, new NullableNotNullManager(project) {
            @Override
    ...
    private static List<File> getClasspath(@NotNull K2JVMCompilerArguments arguments, List<Path> libraries) {
        ...
        if (arguments.getClasspath() != null) {
            for (String element : Splitter.on(File.pathSeparatorChar).split(arguments.getClasspath())) {
