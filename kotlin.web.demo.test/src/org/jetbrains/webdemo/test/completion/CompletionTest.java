...
public class CompletionTest extends BaseTest {
    ...
    public void test$all$type$in$constructor() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"package\",\"name\":\"StrictMath\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StrictMath : Object\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"String : Comparable<String>, CharSequenc...\",\"tail\":\"\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, charset : Char...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, charsetName : ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, i : Int, i1 : ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, offset : Int, ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, offset : Int, ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(chars : CharArray)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(stringBuffer : StringBuffer)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(stringBuilder : StringBuilder)\",\"tail\":\"jet.String\"},{\"icon\":\"package\",\"name\":\"StringBuffer\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringBuffer : AbstractStringBuilder, Se...\",\"tail\":\"\"},{\"icon\":\"package\",\"name\":\"StringBuilder\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringBuilder : AbstractStringBuilder, S...\",\"tail\":\"\"},{\"icon\":\"package\",\"name\":\"StringCoding\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringCoding : Object\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringIndexOutOfBoundsException : IndexO...\",\"tail\":\"\"},{\"icon\":\"package\",\"name\":\"StringValue\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringValue : Object\",\"tail\":\"\"}]";
    ...
    public void test$java$println() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"method\",\"name\":\"print(p0 : Any?)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : Boolean)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : Char)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : CharArray?)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : Double)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : Float)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : Int)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : Long)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"print(p0 : String?)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"printf(p0 : Locale?, p1 : String?, p2 : ...\",\"tail\":\"java.io.PrintStream\"},{\"icon\":\"method\",\"name\":\"printf(p0 : String?, p1 : Array<Any?>)\",\"tail\":\"java.io.PrintStream\"},{\"icon\":\"method\",\"name\":\"println()\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Any?)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Boolean)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Char)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : CharArray?)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Double)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Float)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Int)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : Long)\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"println(p0 : String?)\",\"tail\":\"jet.Unit\"}]";

        compareResult(1, 15, expectedResult, "java");
    }

    public void test$js$a() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"package\",\"name\":\"annotation\",\"tail\":\"\"},{\"icon\":\"genericValue\",\"name\":\"args : Array<String>\",\"tail\":\"jet.Array<jet.String>\"},{\"icon\":\"method\",\"name\":\"array(t : Array<T>)\",\"tail\":\"jet.Array<T>\"},{\"icon\":\"method\",\"name\":\"arrayList(values : Array<T>)\",\"tail\":\"java.util.ArrayList<T>\"},{\"icon\":\"method\",\"name\":\"arrayListOf(values : Array<T>)\",\"tail\":\"java.util.ArrayList<T>\"},{\"icon\":\"method\",\"name\":\"arrayOfNulls(size : Int)\",\"tail\":\"jet.Array<T?>\"},{\"icon\":\"method\",\"name\":\"assert(value : Boolean, lazyMessage : Fu...\",\"tail\":\"jet.Unit\"},{\"icon\":\"method\",\"name\":\"assert(value : Boolean, message : Any)\",\"tail\":\"jet.Unit\"},{\"icon\":\"class\",\"name\":\"atomic : Annotation\",\"tail\":\"\"}]";
