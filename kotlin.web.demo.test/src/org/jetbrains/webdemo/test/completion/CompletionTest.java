...
public class CompletionTest extends BaseTest {
    ...
    public void test$java$system() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"package\",\"name\":\"System\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"System : Object\",\"tail\":\"\"}]";
    ...
    public void test$all$type$in$constructor() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"package\",\"name\":\"StrictMath\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StrictMath : Object\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"String : Comparable<String>, CharSequenc...\",\"tail\":\"\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, charset : Char...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, charsetName : ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, i : Int, i1 : ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, offset : Int, ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, offset : Int, ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(chars : CharArray)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(stringBuffer : StringBuffer)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(stringBuilder : StringBuilder)\",\"tail\":\"jet.String\"},{\"icon\":\"package\",\"name\":\"StringBuffer\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringBuffer : AbstractStringBuilder, Se...\",\"tail\":\"\"},{\"icon\":\"package\",\"name\":\"StringBuilder\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringBuilder : AbstractStringBuilder, S...\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringIndexOutOfBoundsException : IndexO...\",\"tail\":\"\"}]";
