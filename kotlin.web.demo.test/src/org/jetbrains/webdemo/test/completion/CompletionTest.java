...
public class CompletionTest extends BaseTest {
    ...
    public void test$all$variable() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"property\",\"name\":\"stdin\",\"tail\":\"BufferedReader\"},{\"icon\":\"method\",\"name\":\"stdlib_emptyList()\",\"tail\":\"List<T>\"},{\"icon\":\"property\",\"name\":\"stdlib_emptyList\",\"tail\":\"List<Any>\"},{\"icon\":\"method\",\"name\":\"stdlib_emptyMap()\",\"tail\":\"Map<K, V>\"},{\"icon\":\"property\",\"name\":\"stdlib_emptyMap\",\"tail\":\"Map<Any, Any>\"},{\"icon\":\"method\",\"name\":\"stream(initialValue: T, nextFunction: (T...\",\"tail\":\"Stream<T>\"},{\"icon\":\"method\",\"name\":\"stream(nextFunction: () -> T?)\",\"tail\":\"Stream<T>\"},{\"icon\":\"method\",\"name\":\"streamOf(progression: Progression<T>)\",\"tail\":\"Stream<T>\"},{\"icon\":\"method\",\"name\":\"streamOf(vararg elements: T)\",\"tail\":\"Stream<T>\"},{\"icon\":\"property\",\"name\":\"str\",\"tail\":\"String\"}]";
    ...
    public void test$all$type$in$constructor() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"class\",\"name\":\"StrictMath\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"String\",\"tail\":\" (kotlin)\"},{\"icon\":\"method\",\"name\":\"String(bytes: ByteArray)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(bytes: ByteArray, charset: Charse...\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(bytes: ByteArray, charsetName: St...\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(bytes: ByteArray, i: Int, i1: Int...\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(bytes: ByteArray, offset: Int, le...\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(bytes: ByteArray, offset: Int, le...\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(chars: CharArray)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(stringBuffer: StringBuffer)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(stringBuilder: StringBuilder)\",\"tail\":\"String\"},{\"icon\":\"class\",\"name\":\"StringBuffer\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"StringBuilder\",\"tail\":\" (java.lang)\"},{\"icon\":\"method\",\"name\":\"StringBuilder(body: StringBuilder.() -> ...\",\"tail\":\"StringBuilder\"},{\"icon\":\"class\",\"name\":\"StringCoding\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"StringIndexOutOfBoundsException\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"StringValue\",\"tail\":\" (java.lang)\"}]";
