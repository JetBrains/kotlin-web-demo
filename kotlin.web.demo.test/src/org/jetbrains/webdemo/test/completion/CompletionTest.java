...
public class CompletionTest extends BaseTest {
    ...
    public void test$all$type$in$constructor() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"class\",\"name\":\"StrictMath : Object\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"String : Comparable<String>, CharSequenc...\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"String : Serializable, Comparable<String...\",\"tail\":\"\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, charset : Char...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, charsetName : ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, i : Int, i1 : ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, offset : Int, ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(bytes : ByteArray, offset : Int, ...\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(chars : CharArray)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(stringBuffer : StringBuffer)\",\"tail\":\"jet.String\"},{\"icon\":\"method\",\"name\":\"String(stringBuilder : StringBuilder)\",\"tail\":\"jet.String\"},{\"icon\":\"class\",\"name\":\"StringBuffer : AbstractStringBuilder, Se...\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringBuilder : AbstractStringBuilder, S...\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringIndexOutOfBoundsException : IndexO...\",\"tail\":\"\"},{\"icon\":\"class\",\"name\":\"StringTemplate : Object\",\"tail\":\"\"}]";
    ...
    public void test$js$a() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"package\",\"name\":\"annotation\",\"tail\":\"\"},{\"icon\":\"genericValue\",\"name\":\"args : Array<String>\",\"tail\":\"jet.Array<jet.String>\"},{\"icon\":\"method\",\"name\":\"array(t : Array<T>)\",\"tail\":\"jet.Array<T>\"},{\"icon\":\"method\",\"name\":\"arrayList(values : Array<T>)\",\"tail\":\"java.util.ArrayList<T>\"},{\"icon\":\"method\",\"name\":\"arrayOfNulls(size : Int)\",\"tail\":\"jet.Array<T?>\"},{\"icon\":\"method\",\"name\":\"assert(value : Boolean, lazyMessage : Fu...\",\"tail\":\"Unit\"},{\"icon\":\"method\",\"name\":\"assert(value : Boolean, message : Any)\",\"tail\":\"Unit\"},{\"icon\":\"class\",\"name\":\"atomic : Any\",\"tail\":\"\"}]";
