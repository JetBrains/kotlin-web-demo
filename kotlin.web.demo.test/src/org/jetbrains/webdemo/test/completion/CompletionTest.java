...
public class CompletionTest extends BaseTest {
    ...
    public void test$all$type$in$constructor() throws IOException, JSONException {
        String expectedResult = "[{\"icon\":\"class\",\"name\":\"StrictMath\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"String\",\"tail\":\" (kotlin)\"},{\"icon\":\"method\",\"name\":\"String(ByteArray)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(ByteArray, Charset)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(ByteArray, Int, Int)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(ByteArray, Int, Int, Charset)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(ByteArray, Int, Int, String)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(ByteArray, String)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(CharArray)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(StringBuffer)\",\"tail\":\"String\"},{\"icon\":\"method\",\"name\":\"String(StringBuilder)\",\"tail\":\"String\"},{\"icon\":\"class\",\"name\":\"StringBuffer\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"StringBuilder\",\"tail\":\" (java.lang)\"},{\"icon\":\"method\",\"name\":\"StringBuilder(StringBuilder.() -> Unit)\",\"tail\":\"StringBuilder\"},{\"icon\":\"class\",\"name\":\"StringCoding\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"StringIndexOutOfBoundsException\",\"tail\":\" (java.lang)\"},{\"icon\":\"class\",\"name\":\"StringValue\",\"tail\":\" (java.lang)\"}]";
