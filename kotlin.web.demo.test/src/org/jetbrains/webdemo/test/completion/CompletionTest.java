...
public class CompletionTest extends BaseTest {
    ...
    public void test$java$variable() throws IOException {
        String expectedResult = "[{\"icon\":\"method\",\"text\":\"sequence(\",\"displayText\":\"sequence(() -> T?)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequence(\",\"displayText\":\"sequence(() -> T?, (T) -> T?)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequence(\",\"displayText\":\"sequence(T?, (T) -> T?)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequenceOf(\",\"displayText\":\"sequenceOf(Progression<T>)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequenceOf(\",\"displayText\":\"sequenceOf(vararg T)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"package\",\"text\":\"sequences\",\"displayText\":\"sequences\",\"tail\":\"package kotlin.sequences\"},{\"icon\":\"method\",\"text\":\"setOf()\",\"displayText\":\"setOf()\",\"tail\":\"Set<T>\"},{\"icon\":\"method\",\"text\":\"setOf(\",\"displayText\":\"setOf(T)\",\"tail\":\"Set<T>\"},{\"icon\":\"method\",\"text\":\"setOf(\",\"displayText\":\"setOf(vararg T)\",\"tail\":\"Set<T>\"},{\"icon\":\"method\",\"text\":\"shortArrayOf(\",\"displayText\":\"shortArrayOf(vararg Short)\",\"tail\":\"ShortArray\"},{\"icon\":\"method\",\"text\":\"sortedMapOf(\",\"displayText\":\"sortedMapOf(vararg Pair<K, V>)\",\"tail\":\"SortedMap<K, V>\"},{\"icon\":\"method\",\"text\":\"sortedSetOf(\",\"displayText\":\"sortedSetOf(Comparator<in T>, vararg T)\",\"tail\":\"TreeSet<T>\"},{\"icon\":\"method\",\"text\":\"sortedSetOf(\",\"displayText\":\"sortedSetOf(vararg T)\",\"tail\":\"TreeSet<T>\"},{\"icon\":\"property\",\"text\":\"stdin\",\"displayText\":\"stdin\",\"tail\":\"BufferedReader\"},{\"icon\":\"property\",\"text\":\"str\",\"displayText\":\"str\",\"tail\":\"String\"},{\"icon\":\"package\",\"text\":\"sun\",\"displayText\":\"sun\",\"tail\":\"package sun\"},{\"icon\":\"package\",\"text\":\"sunw\",\"displayText\":\"sunw\",\"tail\":\"package sunw\"},{\"icon\":\"package\",\"text\":\"support\",\"displayText\":\"support\",\"tail\":\"package kotlin.support\"},{\"icon\":\"method\",\"text\":\"synchronized(\",\"displayText\":\"synchronized(Any, () -> R)\",\"tail\":\"R\"},{\"icon\":\"package\",\"text\":\"system\",\"displayText\":\"system\",\"tail\":\"package kotlin.system\"},{\"icon\":\"\",\"text\":\"super\",\"displayText\":\"super\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"setparam\",\"displayText\":\"setparam\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"set\",\"displayText\":\"set\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"sealed\",\"displayText\":\"sealed\",\"tail\":\"\"}]";
        compareResult(14, 23, expectedResult, "java");}

    public void test$js$variable() throws IOException {
        String expectedResult = "[{\"icon\":\"method\",\"text\":\"safeParseDouble(\",\"displayText\":\"safeParseDouble(String)\",\"tail\":\"Double?\"},{\"icon\":\"method\",\"text\":\"safeParseInt(\",\"displayText\":\"safeParseInt(String)\",\"tail\":\"Int?\"},{\"icon\":\"method\",\"text\":\"sequence(\",\"displayText\":\"sequence(() -> T?)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequence(\",\"displayText\":\"sequence(() -> T?, (T) -> T?)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequence(\",\"displayText\":\"sequence(T?, (T) -> T?)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequenceOf(\",\"displayText\":\"sequenceOf(Progression<T>)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"method\",\"text\":\"sequenceOf(\",\"displayText\":\"sequenceOf(vararg T)\",\"tail\":\"Sequence<T>\"},{\"icon\":\"package\",\"text\":\"sequences\",\"displayText\":\"sequences\",\"tail\":\"package kotlin.sequences\"},{\"icon\":\"method\",\"text\":\"setOf()\",\"displayText\":\"setOf()\",\"tail\":\"Set<T>\"},{\"icon\":\"method\",\"text\":\"setOf(\",\"displayText\":\"setOf(T)\",\"tail\":\"Set<T>\"},{\"icon\":\"method\",\"text\":\"setOf(\",\"displayText\":\"setOf(vararg T)\",\"tail\":\"Set<T>\"},{\"icon\":\"method\",\"text\":\"shortArrayOf(\",\"displayText\":\"shortArrayOf(vararg Short)\",\"tail\":\"ShortArray\"},{\"icon\":\"property\",\"text\":\"str\",\"displayText\":\"str\",\"tail\":\"String\"},{\"icon\":\"package\",\"text\":\"support\",\"displayText\":\"support\",\"tail\":\"package kotlin.support\"},{\"icon\":\"method\",\"text\":\"synchronized(\",\"displayText\":\"synchronized(Any, crossinline () -> R)\",\"tail\":\"R\"},{\"icon\":\"\",\"text\":\"super\",\"displayText\":\"super\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"setparam\",\"displayText\":\"setparam\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"set\",\"displayText\":\"set\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"sealed\",\"displayText\":\"sealed\",\"tail\":\"\"}]";
        compareResult(14, 23, expectedResult, "js");
    }

    public void test$all$class() throws IOException {
        String expectedResult = "[{\"icon\":\"class\",\"text\":\"GeneratorSequence\",\"displayText\":\"GeneratorSequence\",\"tail\":\" (kotlin.sequences)\"},{\"icon\":\"class\",\"text\":\"Greeter\",\"displayText\":\"Greeter\",\"tail\":\" (<root>)\"}]";
    ...
    public void test$js$a() throws IOException {
        String expectedResult = "[{\"icon\":\"package\",\"text\":\"annotation\",\"displayText\":\"annotation\",\"tail\":\"package kotlin.annotation\"},{\"icon\":\"genericValue\",\"text\":\"args\",\"displayText\":\"args\",\"tail\":\"Array<String>\"},{\"icon\":\"method\",\"text\":\"arrayCopyResize(\",\"displayText\":\"arrayCopyResize(Any?, Int, Any?)\",\"tail\":\"Any?\"},{\"icon\":\"method\",\"text\":\"arrayListOf(\",\"displayText\":\"arrayListOf(vararg T)\",\"tail\":\"ArrayList<T>\"},{\"icon\":\"method\",\"text\":\"arrayOf(\",\"displayText\":\"arrayOf(vararg T)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOf(\",\"displayText\":\"arrayOf(vararg T)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOfNulls(\",\"displayText\":\"arrayOfNulls(Array<out T>, Int)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOfNulls(\",\"displayText\":\"arrayOfNulls(Int)\",\"tail\":\"Array<T?>\"},{\"icon\":\"method\",\"text\":\"arrayPlusCollection(\",\"displayText\":\"arrayPlusCollection(Any?, Collection<T>)\",\"tail\":\"Any?\"},{\"icon\":\"\",\"text\":\"as\",\"displayText\":\"as\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"abstract\",\"displayText\":\"abstract\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"annotation\",\"displayText\":\"annotation\",\"tail\":\"\"}]";

        compareResult(2, 3, expectedResult, "js");
    }

    public void test$kt$a() throws IOException {
        String expectedResult = "[{\"icon\":\"package\",\"text\":\"annotation\",\"displayText\":\"annotation\",\"tail\":\"package java.lang.annotation\"},{\"icon\":\"package\",\"text\":\"annotation\",\"displayText\":\"annotation\",\"tail\":\"package kotlin.annotation\"},{\"icon\":\"genericValue\",\"text\":\"args\",\"displayText\":\"args\",\"tail\":\"Array<String>\"},{\"icon\":\"method\",\"text\":\"arrayListOf(\",\"displayText\":\"arrayListOf(vararg T)\",\"tail\":\"ArrayList<T>\"},{\"icon\":\"method\",\"text\":\"arrayOf(\",\"displayText\":\"arrayOf(vararg T)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOf(\",\"displayText\":\"arrayOf(vararg T)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOfNulls(\",\"displayText\":\"arrayOfNulls(Array<out T>, Int)\",\"tail\":\"Array<out T>\"},{\"icon\":\"method\",\"text\":\"arrayOfNulls(\",\"displayText\":\"arrayOfNulls(Int)\",\"tail\":\"Array<T?>\"},{\"icon\":\"method\",\"text\":\"assert(\",\"displayText\":\"assert(Boolean)\",\"tail\":\"Unit\"},{\"icon\":\"method\",\"text\":\"assert(\",\"displayText\":\"assert(Boolean, () -> Any)\",\"tail\":\"Unit\"},{\"icon\":\"method\",\"text\":\"assert(\",\"displayText\":\"assert(Boolean, Any)\",\"tail\":\"Unit\"},{\"icon\":\"\",\"text\":\"as\",\"displayText\":\"as\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"abstract\",\"displayText\":\"abstract\",\"tail\":\"\"},{\"icon\":\"\",\"text\":\"annotation\",\"displayText\":\"annotation\",\"tail\":\"\"}]";
