...
public class CompletionTest extends BaseTest {
    ...
    public void test$js$a() throws IOException {
        String expectedResult = "[{\"icon\":\"genericValue\",\"text\":\"args\",\"displayText\":\"args\",\"tail\":\"Array<String>\"},{\"icon\":\"method\",\"text\":\"arrayCopyResize(\",\"displayText\":\"arrayCopyResize(Any?, Int, Any?)\",\"tail\":\"Any?\"},{\"icon\":\"method\",\"text\":\"arrayListOf(\",\"displayText\":\"arrayListOf(vararg T)\",\"tail\":\"ArrayList<T>\"},{\"icon\":\"method\",\"text\":\"arrayOf(\",\"displayText\":\"arrayOf(vararg T)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOfNulls(\",\"displayText\":\"arrayOfNulls(Array<out T>, Int)\",\"tail\":\"Array<T>\"},{\"icon\":\"method\",\"text\":\"arrayOfNulls(\",\"displayText\":\"arrayOfNulls(Int)\",\"tail\":\"Array<T?>\"},{\"icon\":\"method\",\"text\":\"arrayPlusCollection(\",\"displayText\":\"arrayPlusCollection(Any?, Collection<T>)\",\"tail\":\"Any?\"}]";
