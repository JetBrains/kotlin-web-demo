...
import org.jetbrains.jet.internal.com.intellij.util.ImageLoader;
import org.jetbrains.jet.internal.com.intellij.util.containers.ConcurrentHashMap;
import org.jetbrains.jet.internal.com.intellij.util.containers.WeakHashMap;
...
public final class IconLoader {
  private static final Logger LOG = Logger.getInstance("#org.jetbrains.jet.internal.com.intellij.openapi.util.IconLoader");
   ...
   * Use only if you expected null return value, otherwise see {@link org.jetbrains.jet.internal.com.intellij.openapi.util.IconLoader#getIcon(String)}
   */
  ...
  /**
   * Might return null if icon was not found.
   * Use only if you expected null return value, otherwise see {@link org.jetbrains.jet.internal.com.intellij.openapi.util.IconLoader#getIcon(String, Class)}
   */
  @Nullable
