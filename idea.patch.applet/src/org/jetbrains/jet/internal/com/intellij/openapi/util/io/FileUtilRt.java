...
import org.jetbrains.jet.internal.com.intellij.openapi.diagnostic.LoggerRt;
import org.jetbrains.jet.internal.com.intellij.openapi.util.SystemInfoRt;
import org.jetbrains.jet.internal.com.intellij.openapi.util.text.StringUtilRt;
...
public class FileUtilRt {
    ...
    public static String getRelativePath(@NotNull String basePath, @NotNull String filePath, final char separator) {
        return getRelativePath(basePath, filePath, separator, true /*SystemInfoRt.isFileSystemCaseSensitive*/);
    }
