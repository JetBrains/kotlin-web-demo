 ...
 */
package org.jetbrains.jet.internal.com.intellij.errorreport.bean;
...
public class ErrorBean {
    ...
    public ErrorBean(String message, String stackTrace, String lastAction) {
        if (message != null) {
    ...
    public void addProgramText(String programText) {
        this.message = getMessageText(message, programText);
    }

    private String getMessageText(String message, String text) {
