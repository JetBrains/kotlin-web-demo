...
var CodeMirror = (function () {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function markText(from, to, className) {
            ...
            function add(line, from, to, className) {
                mark = lines[line].addMark(from, to, className, set, line);
            }
    ...
    Line.prototype = {
        ...
        addMark:function (from, to, style, set, lineNum) {
            set.push(this);
            if (this.marked == null) this.marked = [];
            this.marked.push({from:from, to:to, style:style, set:set, lineNum: lineNum});
